        ...
        <div class="row">
            ...
            <div class="col-12">
             <div class="card">
               ...
               <div class="card-body">
                <form action="{{ route('page.update',$page)}}" enctype="multipart/form-data" method="POST">
                  @csrf
                      
                  
                      <div class="position-relative">
                        <label for="validationTooltip04" class="ps-2">Name</label>
                        <input type="text" name="name" class="form-control" id="validationTooltip04" value="{{ $page->name}}" required>
                    </div>
                    <div class="position-relative">
                        <label for="validationTooltip04" class="ps-2">Image</label>
                        <input type="file" name="image" class="form-control" id="validationTooltip04" value="{{ $page->image}}" required>
                    </div>
                    <div class="position-relative">
