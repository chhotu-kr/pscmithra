...
<aside id="sidebar" class="sidebar">
 ...
 <li class="nav-item">
  <a class="nav-link collapsed" data-bs-target="#tables" data-bs-toggle="collapse" href="#">
    <i class="bi bi-layout-text-window-reverse"></i><span>Question</span><i class="bi bi-chevron-down ms-auto"></i>
  </a>
...
<li class="nav-item">
  <a class="nav-link collapsed" href="{{route('manage.livetest')}}">
    <i class="bi bi-circle"></i><span>Manage Livetest</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link collapsed" data-bs-target="#study" data-bs-toggle="collapse" href="#">
    <i class="bi bi-layout-text-window-reverse"></i><span>StudyMetrial</span><i class="bi bi-chevron-down ms-auto"></i>
  </a>
  <ul id="study" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    <li class="nav-item">
