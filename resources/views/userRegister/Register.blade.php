          ...
          <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto mt-5">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="{{route('user.signup')}}" class="row g-3 needs-validation" method="POST" novalidate>
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="contact" class="form-control" id="yourUsername" required>
