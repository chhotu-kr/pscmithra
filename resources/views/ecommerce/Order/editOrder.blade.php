                            ...
                            @csrf
                               ...
                               <div class="row">
                                   <div class="mb-3 col">
                                       ...
                                       <input type="text" class="form-control" name="isDeliverd" value="{{$order->isDeliverd}}">
                                       @error('isDeliverd')
                                           <p class="small text-danger">{{$message}}</p>
                                       @enderror
                                   </div>
                                   <div class="mb-3 col">
                                        ...
                                        <input type="text" class="form-control" name="isProcessing" value="{{$order->isProcessing}}">
                                        @error('isProcessing')
                                            <p class="small text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 col">
                                        ...
                                        <input type="text" class="form-control" name="isShipped" value="{{$order->isShipped}}">
                                        @error('isShipped')
                                            <p class="small text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                               ...
                               <div class="row">
                                   <div class="mb-3 col">
                                       ...
                                       <input type="date" class="form-control" name="dateOfOrderd" value="{{$order->dateOfOrderd}}">
                                       @error('dateOfOrderd')
                                           <p class="small text-danger">{{$message}}</p>
                                       @enderror
                                   </div>
                                   <div class="mb-3 col">
                                    ...
                                    <input type="text" class="form-control" name="ordered" value="{{$order->ordered}}">
                                    @error('ordered')
                                        <p class="small text-danger">{{$message}}</p>
                                    @enderror
                                </div>
