    ...
    <div class="container mt-5">
        <div class="row mb-8">
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                <h2 class="me-7 me-xl-14 text-dark">
                   Learn React Native
                </h2>
                <p class="me-xl-13 mb-4">Master Figma app to get a job in UI Design, User Interface, User Experience design,
                    Web Design &amp; UX design.</p>
                    ...
                    <div class="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6">
                        <div class="p-2">
                            <img src="data:image/png;base64,"
                                alt="..." class="rounded-circle" width="68" height="68">
                        </div>
                    </div>

                    <div class="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        <h6 class="mb-0">Created by</h6>
                        <a href="#" class="font-size-sm text-secondary">Alison Dawn</a>
                    </div>

                    <div class="mb-4 ms-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        <h6 class="mb-0">Categories</h6>
                        <a href="#" class="font-size-sm text-secondary">Design</a>
                    </div>

                    <div class="mb-4 ms-4 mb-md-0 me-md-6 me-lg-4 me-xl-6">
                    ...
                    <div id="accordionCurriculum">
                        <div class="border rounded shadow mb-6 overflow-hidden">
                            <div class="d-flex align-items-center" id="curriculumheadingOne">
                                <h5 class="mb-0 w-100">
                                    <button style="border: 1.4px solid #145ba9"
                                        class="d-flex align-items-center w-100 p-4 bg-light text-dark fw-medium collapse-accordion-toggle "
                ...
                {{-- About inStructor --}}
                <div id="Instructor" class="mb-5">

                    <h3 class="mb-6">About the instructor</h3>

                    <div class="row mx-xl-n5 mb-4 ">
                    ...
                    <p class="mb-6 line-height-md">I am a UI/UX designer and an iOS developer with having almost six years
                        of experience in application development and also ten years of graphic design and User Interface
                        design.</p>
                    <p class="mb-6 line-height-md">My passion is helping people to learn new skills in a short-term course
                        and achieve their goals. I've been designing for more than ten years and developing iOS apps for
                        four years. It's my honor if I could help you learn to program in a simple word. I currently am
                        teaching iOS 13, Swift 5, ARKit 3, Sketch 5, Illustrator, Photoshop, Cinema 4D, HTML, CSS,
                        JavaScript, etc.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-block rounded border p-2 shadow mb-6">
                    <img src="{{ asset('upload/18e70d2b4f13a01ee06de9a0443b0be8_original.webp') }}"
                        class="d-block sk-thumbnail rounded mb-1" data-fancybox="" />


                    <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                        <div class="d-flex align-items-center mb-2">
                            <ins class="h2 p-2 mb-4 text-white" style="background-color: #145ba9">$89.99</ins>
                            <del class="ms-3">339.99</del>
                            <div class="text-dark ms-auto fw-normal">91% Off</div>
                        </div>

                        <div class="d-flex align-items-center text-alizarin mb-5">
                            <!-- Icon -->
                        ...
                        <div class="d-flex">
                            <button class="btn btn-success btn-block mb-3 p-3 w-50" style="font-size: 13px" type="button" name="button">BUY
                                NOW</button>
                            <button class="btn btn-primary btn-block mb-3 ms-4 p-3 w-50" style="font-size: 13px" type="button"
                                name="button">ENROLL</button>
                        </div>
