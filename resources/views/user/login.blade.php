                    ...
                    <div class="login-form-box">
                        ...
                        <form action="{{route('user.login')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" id="current-log-email" placeholder="Enter User Contact" required>
                            </div>
                            <div class="form-group">
                                <label for="current-log-password">Password</label>
                                <input type="text" name="password" id="current-log-password" placeholder="Enter User Password" required>
