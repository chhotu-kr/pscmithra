			...
			<div class="col-lg-10 order-lg-last">
				...
				<div class="container-form-box">
                    <section class="tabSection">
                      ...
                      <input type="text" class="form-control w-50" placeholder="First name*" required="">
                      <input type="text" class="form-control w-50" placeholder="Last name*" required="">
                      <input type="email" class="form-control w-50" placeholder="Email*" required="">
                      
                        <select class="form-control w-50" id="" required="">
                    ...
                    <div class="otpfild w-50">
                        <input type="number" class="form-control " placeholder="Phone number*" required="">
                        <a href="">Send OTP</a>
                    </div>
                    
                    <input type="number" class="form-control w-50" placeholder="OTP" required="">
                      <div class="btn-main w-50">
                            <div class="button next" id="next">Submit →</div>
                      </div>
                    </section>
                        ...
                        <div class="tab-content pt-2">
                          ...
                          <div class="tab-pane fade show  profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-9 col-md-8">{{$item->contact}}</div>
                            </div>
