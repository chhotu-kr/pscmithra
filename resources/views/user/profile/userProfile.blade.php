              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <form action="{{route('update.user')}}" method="POST">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="contact" type="text" class="form-control" id="Phone" value="{{$current_user->contact}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="gender" type="text" class="form-control" id="Email" value="{{$current_user->gender}}">
                    </div>
                  </div>
