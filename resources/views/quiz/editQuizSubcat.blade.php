              ...
              @csrf
                <div class=" position-relative">
                  ...
                  <div class="position-relative">
                    ...
                    <input type="file" name="image" class="form-control mb-3" id="validationTooltip04" value="{{ $quizsubcat->image}}" required>
                  </div>

                  @livewire('imageview', ['image' => ['image' => $quizsubcat->image,'w'=>'80','h'=>'80']], key($item->id))
