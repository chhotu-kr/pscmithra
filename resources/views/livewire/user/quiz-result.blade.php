                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <div class="boxdiv rounded-pill mt-2" style="background-color: #f1ebeb">
                            <span
                                class="badge p-3 rounded-pill bg-secondary mt-1 ms-3">{{ $data['unseen'] + $data['skip'] }}</span>
                                    ...
                                    <div class="user-attempt-question">
                                        <div class="user-profile mb-3">
                                            ...
                                            @elseif ($data['reAttempId'] != '' && $data['reAttempResult'] == false)
                                                <div class="text-light btn btn-success" style="height: 31px"
                                                    wire:click.prevent="reattempt()">
                                                    <span style="font-size: 14px">
                                                        Resume Reattempt
                                                    </span>
                                                </div>
                                            ...
                                            <div class="text-light btn btn-danger ms-3" data-bs-toggle="modal"
                                                wire:click.prevent="solution()" data-bs-target="#staticBackdrop"
                                                style="height: 31px">
                                                <span style="font-size: 14px">
                                                    Click for Solution
                                                </span>
