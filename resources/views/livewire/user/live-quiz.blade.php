                            ...
                            <div class="content">
                                ...
                                <ul class="Attempt-sec">
                                    ...
                                    <li class="flex mv-0-67 mv-0-50-l "><span>Max Marks: </span><span
                                            class="ml-auto">{{ $item['marks'] }}</span></li>
                                    <li class="flex mv-0-67 mv-0-50-l "><span>Start At: </span><span
                                            class="ml-auto">{{ $item['final_start'] }}</span></li>
                                    <li class="flex mv-0-67 mv-0-50-l "><span>End At: </span><span
                                            class="ml-auto">{{ $item['final_end'] }}</span></li>
                                ...
                                <a class="education-btn btn-medium w-100"
                                    wire:click.prevent="checkLogin('{{ $item['id'] }}')">Attempt<i
                                        class="icon-4"></i></a>
                            </div>
                        </div>
                    </div>
