        ...
        <div class="row">
            <div class="col-md-8">
                <h5 class="text-center">
                    <a class="link text-decoration-underline" data-bs-toggle="collapse" href="#collapseExample" role="button"
                ...
                <form id="regForm" style="margin-top:-30px">
                    ...
                    <div style="overflow:auto;">
                        <div style="float:right;">
                            ...
                            <button type="button" class="me-2" id="prevBtn" type="button">Previous</button>
                ...
                <div class="user-attempt-question">
                    ...
                    <div class="quition-number-plate">
                        ...
                        <div class="quition-no-box-section">
                            <a><span style="background: #9e9e9e;">2</span></a>
                            <a><span style="background: #9e9e9e;">2</span></a>
                            <a><span style="background: #9e9e9e;">2</span></a>
                            <a><span style="background: #9e9e9e;">2</span></a>
                            <a><span style="background: #9e9e9e;">2</span></a>
